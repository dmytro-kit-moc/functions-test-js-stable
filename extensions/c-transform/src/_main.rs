        ...
        .filter_map(|definition| {
            ...
            (components_in_cart.len() == definition.component_reference.len()).then(|| {
                ...
                let merge_operation = MergeOperation {
                    ...
                    title: Some(String::from("My custom bundle (-33% off)")),
                    cart_lines,

                    image: Some(ImageInput {
                        url: "https://cdn.shopify.com/s/files/1/0458/3856/5534/products/bold-blue_1024x1024@2x.jpg?v=1653552544".to_string()
                    }),
